...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalLayoutOverallMiddle = QtWidgets.QVBoxLayout()
        self.verticalLayoutOverallMiddle.setObjectName("verticalLayoutOverallMiddle")
        ...
        self.verticalLayoutOverallMiddle.addWidget(self.frameOverallGraphic1)
        ...
        self.horizontalLayout_12 = QtWidgets.QHBoxLayout(self.frameOverallGraphic2)
        ...
        self.horizontalLayout_12.addWidget(self.widgetOverallGraphic2)
        self.verticalLayoutOverallMiddle.addWidget(self.frameOverallGraphic2)
        self.horizontalLayoutOverallMain.addLayout(self.verticalLayoutOverallMiddle)
        ...
        self.horizontalLayout_11 = QtWidgets.QHBoxLayout(self.frameOverallGraphic3)
        ...
        self.horizontalLayout_11.addWidget(self.widgetOverallGraphic3)
        self.verticalLayoutOverallRight.addWidget(self.frameOverallGraphic3)
        self.frameOverallGraphic4 = QtWidgets.QFrame(self.tabOverallSummary)
        self.frameOverallGraphic4.setFrameShape(QtWidgets.QFrame.Shape.StyledPanel)
        self.frameOverallGraphic4.setFrameShadow(QtWidgets.QFrame.Shadow.Plain)
        self.frameOverallGraphic4.setObjectName("frameOverallGraphic4")
        self.horizontalLayout_13 = QtWidgets.QHBoxLayout(self.frameOverallGraphic4)
        self.horizontalLayout_13.setContentsMargins(1, 1, 1, 1)
        self.horizontalLayout_13.setSpacing(0)
        self.horizontalLayout_13.setObjectName("horizontalLayout_13")
        self.widgetOverallGraphic4 = QtWidgets.QWidget(self.frameOverallGraphic4)
        self.widgetOverallGraphic4.setObjectName("widgetOverallGraphic4")
        self.horizontalLayout_13.addWidget(self.widgetOverallGraphic4)
        self.verticalLayoutOverallRight.addWidget(self.frameOverallGraphic4)
        self.horizontalLayoutOverallMain.addLayout(self.verticalLayoutOverallRight)
        self.horizontalLayoutOverallMain.setStretch(0, 3)
        self.horizontalLayoutOverallMain.setStretch(1, 5)
        self.horizontalLayoutOverallMain.setStretch(2, 5)
