...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.labelStart = QtWidgets.QLabel(self.frameSummary)
        self.labelStart.setObjectName("labelStart")
        self.horizontalLayoutSummaryButtons.addWidget(self.labelStart)
        self.lineEditStartTime = QtWidgets.QLineEdit(self.frameSummary)
        font = QtGui.QFont()
        font.setFamily("Consolas")
        self.lineEditStartTime.setFont(font)
        self.lineEditStartTime.setLayoutDirection(QtCore.Qt.LayoutDirection.LeftToRight)
        self.lineEditStartTime.setMaxLength(8)
        self.lineEditStartTime.setCursorPosition(8)
        self.lineEditStartTime.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.lineEditStartTime.setObjectName("lineEditStartTime")
        self.horizontalLayoutSummaryButtons.addWidget(self.lineEditStartTime)
        self.labelEnd = QtWidgets.QLabel(self.frameSummary)
        self.labelEnd.setObjectName("labelEnd")
        self.horizontalLayoutSummaryButtons.addWidget(self.labelEnd)
        self.lineEditEndTime = QtWidgets.QLineEdit(self.frameSummary)
        font = QtGui.QFont()
        font.setFamily("Consolas")
        self.lineEditEndTime.setFont(font)
        self.lineEditEndTime.setMaxLength(8)
        self.lineEditEndTime.setCursorPosition(8)
        self.lineEditEndTime.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.lineEditEndTime.setObjectName("lineEditEndTime")
        self.horizontalLayoutSummaryButtons.addWidget(self.lineEditEndTime)
        self.pushButtonApplyParts = QtWidgets.QPushButton(self.frameSummary)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/icons/check-check.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.pushButtonApplyParts.setIcon(icon)
        self.pushButtonApplyParts.setObjectName("pushButtonApplyParts")
        self.horizontalLayoutSummaryButtons.addWidget(self.pushButtonApplyParts)
        ...
        self.horizontalLayoutSummaryButtons.setStretch(1, 1)
        self.horizontalLayoutSummaryButtons.setStretch(3, 1)
        self.horizontalLayoutSummaryButtons.setStretch(4, 1)
        self.horizontalLayoutSummaryButtons.setStretch(5, 2)
        self.horizontalLayoutSummaryButtons.setStretch(6, 1)
        self.horizontalLayoutSummaryButtons.setStretch(7, 1)
        ...
        self.labelOverallWarning = QtWidgets.QLabel(self.tabOverallSummary)
        self.labelOverallWarning.setObjectName("labelOverallWarning")
        self.horizontalLayoutOverallButtons.addWidget(self.labelOverallWarning)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lineEditStartTime.setInputMask(_translate("MainWindow", "00:99:99"))
        self.lineEditStartTime.setText(_translate("MainWindow", "::"))
        self.lineEditStartTime.setPlaceholderText(_translate("MainWindow", "00:00:00"))
        self.labelEnd.setText(_translate("MainWindow", "End"))
        self.lineEditEndTime.setInputMask(_translate("MainWindow", "00:99:99"))
        self.lineEditEndTime.setText(_translate("MainWindow", "::"))
        self.lineEditEndTime.setPlaceholderText(_translate("MainWindow", "99:99:99"))
        self.pushButtonApplyParts.setText(_translate("MainWindow", "Apply"))
        self.pushButtonExportDisplayed.setToolTip(_translate("MainWindow", "Export a series for the selected run only"))
        self.pushButtonExportDisplayed.setText(_translate("MainWindow", "Export CSVs"))
        self.pushButtonOpenReview.setToolTip(_translate("MainWindow", "Open For individual review and playback"))
        self.pushButtonOpenReview.setText(_translate("MainWindow", "Open Review"))
        ...
        self.labelOverallWarning.setText(_translate("MainWindow", "Display Maximums: 2 Pitch Histograms, 4 Eye 2D Y Gaze Plots"))
