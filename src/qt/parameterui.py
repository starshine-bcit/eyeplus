...
class Ui_parameterDialog(object):
    def setupUi(self, parameterDialog):
        ...
        self.horizontalSliderHorizonFuzzy.setMinimum(-999)
        self.horizontalSliderHorizonFuzzy.setMaximum(999)
    ...
    def retranslateUi(self, parameterDialog):
        ...
        self.labelHorizonFuzzy.setText(_translate("parameterDialog", "Not Implemented"))
